...
public class EmployeeController {
	...
	/*
	 * GET /employees = To list all employees details GET /employees/new = To Add a
	 * new Employee details GET /employees/edit/{id} = To Edit Employee details POST
	 * /employees = Save a new Employee detail POST /employees/{id} = Save updated
	 * employee detail GET /employees/delete/{id} = To Delete Employee details
	 */
